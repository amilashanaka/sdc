...
$form_config = [
    ...
    'title' => 'list',
    'new' => 'package',
    'model' => 'package', // Model/class name for data operations
    'method' => 'get_all_with_delete', // Method to call on the model
    'table' => [
        'th' => ['#', 'package Title', 'price',  'Action'],
        'action_style' => 'width:3%; text-align: center;',
        'id_column' => 'id',
        'columns' => [
            ['name' => '#', 'link' => true],  // ID column (counter)
            ['name' => 'f2', 'link' => true], // package Title column
            ['name' => 'f3', 'link' => false], // Date Start column
 
        ],
        'link_base' => 'package', // Base URL for links
        'table_id' => 'example23',
