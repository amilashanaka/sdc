...
$form_config = [
    ...
    'new' => 'blog',
    'table' => [
        'th' => ['#', 'Application_Name', 'Description', 'Action'],
        'action_style' => 'width:3%; text-align: center;',
        'id_column' => 'id',
        'columns' => [
            ['name' => '#', 'link' => true],  // ID column (counter)
            ['name' => 'f1', 'link' => true], // First data column
            ['name' => 'f2', 'link' => false]  // Second data column (now linkable)
        ],
        'link_base' => 'blog' // Base URL for links
    ],
    'db_table' => 'blogs',
    'redirect' => 'blog_list',
    'buttons' => [
...
$list = $blog->get_all_with_delete()['error'] === null ? $blog->get_all_with_delete()['data'] : null;
?>
