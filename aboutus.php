...
$form_config = [
    'heading' => 'About Us',
    'form_action' => 'data/register_aboutus.php',
    'inputs' => [
         'img1' => ['label' => 'Banner', 'type' => 'file', 'accept' => 'image/*', 'preview' => true, 'div_class' => 'col-lg-4 col-md-4 form-group'],
        'id' => ['type' => 'hidden', 'value' => ''],
        'f1' => ['label' => 'Title', 'type' => 'text', 'class' => 'form-control', 'div_class' => 'col-lg-12 col-md-12 form-group'],
        'f2' => ['label' => 'Content1', 'type' => 'textarea', 'class' => 'form-control summernote', 'div_class' => 'col-lg-12 col-md-12 form-group'],
        'f3' => ['label' => 'Content2', 'type' => 'textarea', 'class' => 'form-control summernote', 'div_class' => 'col-lg-12 col-md-12 form-group'],
