...
array_push($side_menu, array('name' => 'Types', 'icon' => 'fas fa-list', 'url' => '#', 'submenu' => array(array('name' => 'List', 'icon' => 'fas fa-list', 'url' => 'device_type_list'))));
array_push($side_menu, array('name' => 'Error Codes', 'icon' => 'fas fa-bug', 'url' => '#', 'submenu' => array(array('name' => 'List', 'icon' => 'fas fa-list', 'url' => 'error_code_list'))));
...
<aside class="main-sidebar sidebar sidebar-dark-primary elevation-4" id="sidebar">
    ...
    <a href="<?= BASE_URL; ?>/dashboard" class="brand-link">
        <img src="<?= BASE_URL; ?>/assets/img/logo.png" alt="System logo" class="brand-image img-circle elevation-3" style="opacity: .8">
